...
use App\Entity\Contracts\TimeblameableInterface;
use App\Entity\Traits\TimeblameableEntity;
 ...
 *      "type_monthly" = "App\Entity\MonthlyWallet",
 * })
 */
abstract class Wallet implements TimeblameableInterface, \JsonSerializable
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\User", inversedBy="viewableWallets", cascade={"persist", "remove"})
